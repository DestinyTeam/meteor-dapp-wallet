...
Helpers.getAccountByAddress = function(address, reactive) {
    ...
    return EthAccounts.findOne({address: address}, options) || Wallets.findOne({address: address}, options) || Applications.findOne({address: address}, options) || CustomContracts.findOne({address: address}, options);
};
